	...
	<div id="square" style="background-color: #eaeff8;">
		<div id="write-form">
			<table id="fromm-title">
				...
				<tr>
					<td class="info">받은 시간</td><td colspan="3">${viewMessage.send_date }</td>
				</tr>
				<tr>
					<td class="info">제목</td><td colspan="3">${viewMessage.title }</td>
				</tr>							
			</table>		
			<div><textarea name="content" id="content" placeholder="내용" required>${viewMessage.content }</textarea></div>					
		</div>
