...
<tr>
	<td rowspan="2">
	<c:choose>
	<c:when test="${empty boardAskingList.file }">
	<img class="thumbnail" src="https://via.placeholder.com/40" alt="no picture">
	</c:when>
	<c:otherwise>
	<img class="thumbnail" src="${pageContext.request.contextPath}/upload/${boardAskingList.file.thumbnail_url}" alt="no picture">
	</c:otherwise>
	</c:choose>
	</td>
	<td id='title'>
