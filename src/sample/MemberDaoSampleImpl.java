...
public class MemberDaoSampleImpl implements MemberDaoSample {
    @Override
    public List<Member> selectAll(Connection connection) throws SQLException {
        return null;
    }
    ...
    @Override
    public File selectProfileOrNull(Connection connection, int userNo) {
        return null;
    }
