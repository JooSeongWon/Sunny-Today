...
public class BoardServiceImpl implements BoardService {
    ...
    public String SearchNick(Post post_no) {
        ...
        String nick = boardDao.selectNickByUserno(connection, post_no);
    ...
    public String getNick(Post detailBoard) {
        ...
        Connection connection = JDBCTemplate.getConnection();
        String nick = boardDao.selectNickByUserno(connection, detailBoard);
        JDBCTemplate.close(connection);
        return nick;
    }
    ...
    public File detailFile(Post post_no) {
        ...
        Connection connection = JDBCTemplate.getConnection();
        int fileno = boardDao.changeFileno(connection, post_no);
		//System.out.println("BoardService detailFile - fileno : " + fileno);
        File detailFile = boardDao.selectFile(connection, fileno);
    ...
    public int selectPostnoByCommentsNO(int commentNo) {
        Connection connection = JDBCTemplate.getConnection();
        int postno = boardDao.selectPostnoByCommentsNO(connection, commentNo);
        JDBCTemplate.close(connection);
        return postno;
    }
